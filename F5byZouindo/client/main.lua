print("^0======================================================================^7")
print("^0[^4Author^0] ^7:^0 ^0Zouindo^7")
print("^0[^3Version^0] ^7:^0 ^02.0^7")
print("^0[^2Download^0] ^7:^0 ^https://github.com/Experty-Rival/F5byZouindo.git^7")
print("^0[^1Issues^0] ^7:^0 ^5https://github.com/Experty-Rival/F5byZouindo.git^7")
print("^0======================================================================^7")
