...
ESX.RegisterServerCallback('Zouindo-PersonalMenu:Bill_getBills', function(source, cb)
...
ESX.RegisterServerCallback('Zouindo-PersonalMenu:Admin_getUsergroup', function(source, cb)
	local xPlayer = ESX.GetPlayerFromId(source)
...
-- Weapon Menu --
RegisterServerEvent('Zouindo-PersonalMenu:Weapon_addAmmoToPedS')
AddEventHandler('Zouindo-PersonalMenu:Weapon_addAmmoToPedS', function(plyId, value, quantity)
	if #(GetEntityCoords(source, false) - GetEntityCoords(plyId, false)) <= 3.0 then
		TriggerClientEvent('Zouindo-PersonalMenu:Weapon_addAmmoToPedC', plyId, value, quantity)
	end
end)

-- Admin Menu --
RegisterServerEvent('Zouindo-PersonalMenu:Admin_BringS')
AddEventHandler('Zouindo-PersonalMenu:Admin_BringS', function(plyId, targetId)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()

	if isAuthorized(getAdminCommand('bring'), plyGroup) or isAuthorized(getAdminCommand('goto'), plyGroup) then
		local targetCoords = GetEntityCoords(GetPlayerPed(targetId))
		TriggerClientEvent('Zouindo-PersonalMenu:Admin_BringC', plyId, targetCoords)
	end
end)

RegisterServerEvent('Zouindo-PersonalMenu:Admin_giveCash')
AddEventHandler('Zouindo-PersonalMenu:Admin_giveCash', function(money)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()
...
RegisterServerEvent('Zouindo-PersonalMenu:Admin_giveBank')
AddEventHandler('Zouindo-PersonalMenu:Admin_giveBank', function(money)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()
...
RegisterServerEvent('Zouindo-PersonalMenu:Admin_giveDirtyMoney')
AddEventHandler('Zouindo-PersonalMenu:Admin_giveDirtyMoney', function(money)
	local xPlayer = ESX.GetPlayerFromId(source)
	local plyGroup = xPlayer.getGroup()
...
-- Grade Menu --
RegisterServerEvent('Zouindo-PersonalMenu:Boss_promouvoirplayer')
AddEventHandler('Zouindo-PersonalMenu:Boss_promouvoirplayer', function(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_destituerplayer')
AddEventHandler('Zouindo-PersonalMenu:Boss_destituerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_recruterplayer')
AddEventHandler('Zouindo-PersonalMenu:Boss_recruterplayer', function(target, job, grade)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_virerplayer')
AddEventHandler('Zouindo-PersonalMenu:Boss_virerplayer', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_promouvoirplayer2')
AddEventHandler('Zouindo-PersonalMenu:Boss_promouvoirplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_destituerplayer2')
AddEventHandler('Zouindo-PersonalMenu:Boss_destituerplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_recruterplayer2')
AddEventHandler('Zouindo-PersonalMenu:Boss_recruterplayer2', function(target, job2, grade2)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
...
RegisterServerEvent('Zouindo-PersonalMenu:Boss_virerplayer2')
AddEventHandler('Zouindo-PersonalMenu:Boss_virerplayer2', function(target)
	local sourceXPlayer = ESX.GetPlayerFromId(source)
	local targetXPlayer = ESX.GetPlayerFromId(target)
